        ...
        {({
          ...
          <Tabs>
            <Tabs.TabPane key="1" tab="基本配置">
              ...
              />
              <ProFormSwitch
                name="enableBlacklistIpDetection"
                label="开启黑名单检测"
                hidden
              />
              <ProFormSwitch
                name="enableBlacklistIpCollection"
                label="开启黑名单检测"
                hidden
              />
            </Tabs.TabPane>
            <Tabs.TabPane
              key="2"
              tab={<TabTitle title="地区检测" enable={enableRegionDetection} />}
            >
              <ProFormSwitch
                name="enableRegionDetection"
                label="启用地区检测"
              />
              {enableRegionDetection && (
                <ProFormSelect
            ...
            <Tabs.TabPane
              key="3"
              tab={<TabTitle title="爬虫检测" enable={enableSpiderDetection} />}
            >
              <ProFormSwitch
                name="enableSpiderDetection"
                label="启用爬虫检测"
              />
            </Tabs.TabPane>
            <Tabs.TabPane
              ...
              tab={
                <TabTitle
                  title="访客语言检测"
                  enable={enableLanguageDetection}
                />
              }
            >
              <ProFormSwitch
            ...
            <Tabs.TabPane
              key="5"
              tab={<TabTitle title="代理检测" enable={enableProxyDetection} />}
            >
            ...
            <Tabs.TabPane
              key="6"
              tab={<TabTitle title="客户端检测" enable={enableUaDetection} />}
            >
            ...
            <Tabs.TabPane
              key="7"
              tab={
                <TabTitle title="第三方斗篷检测" enable={useCloakProvider} />
              }
            >
              <ProFormSwitch
                name="useCloakProvider"
                label="启用第三方斗篷检测"
              />
              {useCloakProvider && (
                <>
                  ...
                  />
                  <ProFormText
                    name="cloakProviderApiUrl"
                    label="API"
                    rules={[{ required: true }]}
                  />
                  <ProFormText.Password
                    name="cloakProviderApiSecret"
                    label="密钥"
                    rules={[{ required: true }]}
                  />
                </>
            ...
            <Tabs.TabPane
              ...
              tab={
                <TabTitle
                  title="黑名单IP检测"
                  enable={enableBlacklistIpDetection}
                />
              }
            >
              <ProFormSwitch
